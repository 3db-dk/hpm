//! End-to-end integration tests for hpm-core.

use hpm_config::{ProjectsConfig, StorageConfig};
use hpm_core::{DependencyResolver, ProjectDiscovery, StorageManager};
use std::sync::Arc;
...
[dependencies]
package-a = { url = "https://example.com/packages/package-a/1.0.0/package-a-1.0.0.zip", version = "1.0.0" }
"#,
    )
    .unwrap();
...
[dependencies]
package-c = { url = "https://example.com/packages/package-c/1.0.0/package-c-1.0.0.zip", version = "1.0.0" }
"#,
    )
    .unwrap();
